define([
  ...
  function (declare, BaseWidget, Evented, _OnDijitClickMixin, _WidgetsInTemplateMixin,
    ...
    Measurement, geometryEngine, html, ProgressBar, TabContainer, Message, domConstruct, domAttr, baseWin, win, fx) {
    return declare([BaseWidget, _OnDijitClickMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      _getProfile: function (polyline) {
        ...
        // GET LENGTH IN METERS //
          ...
          //RD NEW hack
        var profileLengthMeters = (polyline.spatialReference.wkid != 28992) ? geodesicUtils.geodesicLengths([geoPolyline], Units.METERS)[0] : geometryEngine.planarLength(polyline, 9001); // esriSRUnit_Meter;
